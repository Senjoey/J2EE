...
<body>
	...
	<table>
		...
		<tr>
			...
			CourseService courseService = (CourseService) EJBFactory.getEJB("ejb:/J2EELabEJB/CourseServiceBean!edu.nju.CourseService");
			Course course = courseService.getCourse(select.getCourseId());
			%>
